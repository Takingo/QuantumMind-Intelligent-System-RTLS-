...
class AppConstants {
  ...
  // Supabase Project: QuantumMind RTLS
  static const String supabaseUrl = 'https://xzczebyoupidkuzldesq.supabase.co';
  static const String supabaseAnonKey =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh6Y3plYnlvdXBpZGt1emxkZXNxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjYyNzI4ODksImV4cCI6MjA4MTg0ODg4OX0.Y31O1nJhZWvSxqeugu2wO-__hi6CZvLDuupUl-XAMRw';
  ...
  // ========== Database Tables ==========
  static const String tableProfiles = 'profiles'; // User profiles (auth)
  static const String tableEmployees = 'employees'; // Employee records
  static const String tableDepartments = 'departments'; // Departments
  static const String tableRoles = 'roles'; // Roles with permissions
  static const String tableUsers = 'profiles'; // Backward compatibility
  static const String tableUwbTags = 'tags'; // Changed from 'uwb_tags'
  ...
  // ========== User Roles ==========
  static const String roleAdmin = 'admin'; // Changed to match profiles table
  static const String roleEmployee = 'employee'; // Changed from 'User'
  static const String roleUser = 'employee'; // Backward compatibility
  ...
  static const String espBaseUrl =
      'http://192.168.1.100'; // Replace with ESP32 IP
  ...
  static const int ethernetTimeoutMs = 5000; // 5 seconds
  static const int wifiTimeoutMs = 10000; // 10 seconds
}
